...
class Companies_Post_Type_Registrations {
	...
	public $taxonomies = array( 'companies-type','companies-sector' ,'companies-region','investment-size');
	...
	protected function register_sector_category() {
		...
		register_taxonomy( $this->taxonomies[1], $this->post_type, $args_sector );
	}
	...
	protected function register_region_category(){
		...
		register_taxonomy( $this->taxonomies[2], $this->post_type, $args_region );
	}
	...
	protected function register_investment_size(){
		...
		register_taxonomy( $this->taxonomies[3], $this->post_type, $args_size );
	}
